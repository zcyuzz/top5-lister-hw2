...
export class newTransaction extends jsTPS_Transaction {
    ...
    doTransaction() {
        this.model.renameItem(this.oldItemIndex, this.newItemIndex);
    }
    
    undoTransaction() {
        this.model.renameItem(this.newItemIndex, this.oldItemIndex);
    }
}
